...
3. Do not remove the shared certificate or lock as routine cleanup. If the
   existing certificate is malformed, run the repository-scoped setup command
   printed by Devrouter after checking that no other worktree transition is in
   progress.
