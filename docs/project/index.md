...
- [Devsy release range compatibility](./2026-09-19-devsy-version-range-plan.md) — replace the exact Devsy version pin with a verified `>=1.16.2 <2.0.0` range and resolve the official Linux agent for the installed release.
