...
- [Workspace resource accounting](./2026-08-16-workspace-resource-accounting-roadmap.md) — delivered opt-in, report-only storage consumption in [PR #30](https://github.com/rschlaefli/devrouter/pull/30) and [v0.0.36](https://github.com/rschlaefli/devrouter/releases/tag/v0.0.36); see the [execution plan](./2026-08-16-workspace-resource-accounting-plan.md) for boundary evidence.
