...
| Durable manual lifecycle journal, worker, or effect claims | ADR 0008, Devcontainer manual, generated agent guidance | Model, journal, worker and provider tests plus the saturated-journal liveness suite (`reliability-liveness.test.ts`); `pnpm qualify:lifecycle` installed synthetic proof; real-provider qualification separately. |
| Devsy agent manifest, acquisition, setup, diagnostics, or start preflight | [Architecture](./architecture-and-ownership.md), [managed lifecycle](./managed-environment-lifecycle.md), ADR 0006, Getting Started, Devcontainer manual, generated agent guidance | Agent acquisition, setup, diagnostics, and Devsy mutation tests; package proof; explicit setup plus network-free doctor readback. |
| Managed profile registry, effective Dev Container configuration, or runtime status | [Architecture](./architecture-and-ownership.md), [managed lifecycle](./managed-environment-lifecycle.md), [consumer contract](./consumer-devcontainer-contract.md), [routing contract](./routing-and-runtime-contracts.md), ADR 0005 | Profile/config, generated-file ownership, transition, status/doctor/output, process, and exact stop tests; native full and managed selective smoke. |
| Side-effect-free profile resolution or repository-owned profile-plan contracts | [Architecture](./architecture-and-ownership.md), repository onboarding, generated command guidance, ADR 0007 | Profile resolution/plan and command tests, CLI help, package smoke from a non-Git repository with non-writable home state. |
