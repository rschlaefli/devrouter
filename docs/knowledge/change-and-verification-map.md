...
| Durable manual lifecycle journal, worker, or effect claims | ADR 0008, Devcontainer manual, generated agent guidance | Model, journal, worker and provider tests; `pnpm qualify:lifecycle` installed synthetic proof; real-provider qualification separately. |
