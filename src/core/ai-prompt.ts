...
export function buildOnboardingPrompt(options: InitPromptOptions = {}): string {
  ...
  return [
    ...
    "- Robust app run example (host process wrapped by Infisical): `infisical run --projectId <id> --env=<env> -- pnpm dev` (configure as hostRun.command if this is your standard dev entrypoint).",
